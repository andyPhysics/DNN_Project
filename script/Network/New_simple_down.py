...
output_file = 'SWNN_simple_down.h5'
output_best = 'SWNN_best_simple_down.h5'
cnn_model_name = 'cnn_model_simple_down.h5'
file_path = '/fs/scratch/PAS1495/amedina/processed_simple/'
...
#-----------------------------------------------------------------------
zenith_check = list(zip(images,zenith_values,azimuth_values))
new_images = []
new_zenith_values = []
new_azimuth_values = []
...
x_train,x_test,y_train,y_test = get_data(new_images,cos_values1)
