...
output_file = '/home/amedina/DNN_Project/script/Network/SWNN_simple_all_test.h5'
output_best = '/home/amedina/DNN_Project/script/Network/SWNN_best_simple_up.h5'
cnn_model_name = '/home/amedina/DNN_Project/script/Network/cnn_model_simple_all_test.h5'
...
model.fit_generator(Data_generator(file_path_train,5),
                    epochs = epochs,
                    validation_data=Data_generator(file_path_test,5),
